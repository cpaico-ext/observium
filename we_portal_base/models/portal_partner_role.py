...
class PortalPartnerRole(models.Model):
    ...
    client_id = fields.Many2one(comodel_name='res.partner', string='Client', required=True, ondelete='restrict', help='Company or main partner associated with this role')
    contact_ids = fields.Many2many(
        comodel_name='res.partner',
        relation='portal_partner_role_contact_rel',
        column1='role_id', column2='partner_id',
        string='Contacts', tracking=True,
    ...
    dashboard_ids = fields.Many2many(
        ...
        column1='role_id', column2='dashboard_id',
        string='Dashboards', tracking=True,
    ...
    def action_grant_portal_access(self):
        ...
        wizard = self.env['portal.wizard'].with_context(
            active_ids=partners.ids, active_model='res.partner',
        ).create({})
        return {'type': 'ir.actions.act_window', 'res_model': 'portal.wizard', 'res_id': wizard.id, 'view_mode': 'form', 'target': 'new'}
